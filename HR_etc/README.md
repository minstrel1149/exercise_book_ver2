...
2. Chapter.2 - 서비스 기획을 위해 알아야 할 것들(~ing)
    - Section 2-1. 비즈니스 전략과 서비스 기획
    - Section 2-2. 워터폴 방법론과 애자일 방법론
    - Section 2-3. 서비스 운영 개발 요청서
    - Section 2-4. 기획자 산출물: 서비스 전략 기획서

### 2025년 9월 11일
1. Chapter.2 - 서비스 기획을 위해 알아야 할 것들
    - Section 2-5. 서비스 역기획

### 2025년 9월 12일
1. Chapter.3 - 프로젝트 실무에 돌입하다(~ing)
    - Section 3-1. 마인드맵 그리기: 목표, 데이터, 기능
    - Section 3-2. 기획자 산출물: 마인드맵
    - Section 3-3. 기획자 산출물: 요구사항 정의서

### 2025년 9월 14일
1. Chapter.3 - 프로젝트 실무에 돌입하다
    - Section 3-4. 기획자 산출물: UI 설계 작업(스케치, 와이어프레임, 프로토타입)
    - Section 3-5. 기획자 산출물: 화면설계서와 사용자 스토리

### 2025년 9월 15일
1. Chapter.4 - 프로젝트는 여럿이 함께(~ing)
    - Section 4-1. 화면설계서의 디스크립션 잘 쓰는 방법
    - Section 4-2. 디자이너와 협업하기

### 2025년 9월 16일
1. Chapter.4 - 프로젝트는 여럿이 함께(~ing)
    - Section 4-3. 개발자와 협업하기

### 2025년 9월 17일
1. Chapter.4 - 프로젝트는 여럿이 함께
    - Section 4-4. 기획자 산출물: 테스트 케이스
2. Chapter.5 - 서비스의 탄생
    - Section 5-1. 서비스 오픈
...
1. Chapter.3 - 프로젝트 실무에 돌입하다(~ing)
    - Section 3-3. 기획자 산출물: 요구사항 정의서
    - Section 3-4. 기획자 산출물: 스케치, 와이어프레임, 프로토타입

### 2025년 9월 24일
1. Chapter.3 - 프로젝트 실무에 돌입하다(~ing)
    - Section 3-5. 기획자 산출물: 화면설계서와 사용자 스토리(~ing)