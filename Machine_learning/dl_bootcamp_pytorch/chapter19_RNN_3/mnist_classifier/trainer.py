...
class Trainer():
    ...
    def _batchfy(self, X, y, batch_size=256, random_split=True):
        if random_split:
    ...
    def _train(self, X, y, config):
        ...
        X, y = self._batchfy(X, y, batch_size=config.batch_size, random_split=True)
        total_loss = 0
    ...
    def _validate(self, X, y, config):
        ...
        X, y = self._batchfy(X, y, batch_size=config.batch_size, random_split=False)
        total_loss = 0
