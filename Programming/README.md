...
### 2024년 3월 16일
1. Chapter.1 - 관계형 데이터베이스의 주요 개념
2. Chapter.2 - 정보시스템 구축 절차와 데이터베이스 설계
3. Chapter.3 - 데이터 모델링의 주요 개념
4. Chapter.4 - 모델링 도구
5. Chapter.5 - 업무 분석

### 2024년 3월 17일
1. Chapter.6 - 엔티티의 정의
2. Chapter.7 - 식별자, 관계, 속성의 정의
3. Chapter.8 - 정규화
4. Chapter.9 - 도메인과 용어사전의 정의
5. Chapter.10 - 모델의 검토
6. Chapter.11 - 논리적 설계를 물리적 설계로 전환하기
7. Chapter.12 - 데이터베이스의 구축
8. Appendix-1. 설계 사전
9. Appendix-2. 웹 사이트 게시판을 위한 DB 설계
